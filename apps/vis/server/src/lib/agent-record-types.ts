...
export { AGENT_WIRE_PROTOCOL_VERSION } from '@mirri-ai/agent-core';
export type { Message, ContentPart, ToolCall, TokenUsage } from '@mirri-ai/kosong';
...
import type { AgentRecord, BackgroundTaskInfo } from '@mirri-ai/agent-core';
 ...
 * because the manifest comes from another machine / mirri-code version.
 */
