// apps/mirri-web/src/composables/client/eventBatcher.ts
...
// tested directly. See useMirriWebClient.ts for the WS pipeline wiring.

import type { AppEvent, MirriEventMeta } from '../../api/types';
