// apps/mirri-web/src/composables/messagesToTurns.ts
 ...
 *  resolvePromptMediaFiles in the server prompts route):
 ...
 * (see toProtocolMessage in @mirri-ai/agent-core).
 */
...
export function messagesToTurns(
  ...
  for (const msg of messages) {
    ...
    if (msg.role === 'user') {
      ...
      // A cron injection at a turn boundary flushes and renders as its own
