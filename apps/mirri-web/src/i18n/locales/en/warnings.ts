export default {
  ...
  daemonApiTitle: 'Mirri daemon returned an error',
  daemonNetworkMessage: 'Web did not receive a response from the local service. Check that Mirri daemon is still running, or refresh the page.',
  daemonNetworkTitle: 'Cannot connect to Mirri daemon',
  diagnostics: 'Diagnostics',
  hideDetails: 'Hide details',
  operationFailedMessage: 'The last operation did not finish. Try again later.',
  operationFailedTitle: 'Operation failed',
  sessionSnapshotMessage: 'Web could not load the current conversation. Check that Mirri daemon is still running, or refresh the page.',
