// apps/mirri-web/src/api/daemon/agentEventProjector.ts
//
...
//   apps/mirri-daemon/src/session/event-projector.ts
//   apps/mirri-daemon/src/session/message-log.ts
//   apps/mirri-daemon/src/session/usage-tracker.ts
//
// Usage:
