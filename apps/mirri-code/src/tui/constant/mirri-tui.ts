...
export const LLM_NOT_SET_MESSAGE = 'LLM not set, send "/login-with-kimi" to login';
export const NO_ACTIVE_SESSION_MESSAGE = 'No active session. Send /login-with-kimi to login.';
export const CTRL_D_HINT = 'Press Ctrl+D again to exit';
export const CTRL_C_HINT = 'Press Ctrl+C again to exit';
export const MAIN_AGENT_ID = 'main';
export const OAUTH_LOGIN_REQUIRED_STARTUP_NOTICE = 'OAuth login expired. Send /login-with-kimi to login.';
