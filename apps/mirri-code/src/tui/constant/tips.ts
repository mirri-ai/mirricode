...
export const WORKING_TIPS: readonly ToolbarTip[] = [
  ...
  {
    text: '/plugins: manage plugins — try the "Mirri Datasource" for reliable financial, economic, and academic data',
    solo: true,
    priority: 3,
  },
  { text: 'ask Mirri to schedule tasks, e.g. "remind me at 5pm"', solo: true, priority: 3 },
...
export const ALL_TIPS: readonly ToolbarTip[] = [
  ...
  { text: '/auto when you want Mirri to handle approvals and keep going unattended' },
  ...
  { text: 'shift-tab to Plan mode to review the approach before Mirri edits files.', priority: 2 },
