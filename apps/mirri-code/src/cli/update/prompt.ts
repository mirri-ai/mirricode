...
export const CHANGELOG_URL = 'https://moonshotai.github.io/mirri-code/en/release-notes/changelog.html';
...
function renderInstallPrompt(
  ...
  const lines = [
    chalk.hex(UPDATE_PROMPT_PRIMARY).bold('Mirri Code Update Available'),
