/**
 * Shared helpers for `mirri web` and its subcommands.
 *
...
import type { ServerLogLevel } from '@mirri-ai/kap-server';
 ...
 * is the CLI's own MIRRICODE_HOME resolution (`getDataDir()`).
 *
