...
import type { ContentPart, ToolCall } from '@mirri-ai/mirri-code-sdk';
import type { ContextMessage, PromptOrigin } from '@mirri-ai/mirri-code-sdk';
...
describe('buildExportMarkdown', () => {
  ...
  it('builds complete markdown with frontmatter and overview', () => {
    ...
    expect(md).toContain('# Mirri Session Export');
