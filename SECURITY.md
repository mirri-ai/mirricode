...
Currently, Mirri Code only provides security support for the latest released version.
...
- GitHub Security Advisories — https://github.com/mirri-ai/mirricode/security/advisories/new
