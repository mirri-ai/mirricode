    ...
    const summaries: SessionSummary[] = [
      {
        ...
        title: 'My first chat',
        workDir: '/repo/a',
        sessionDir: '/home/.mirricode/sessions/sess-a',
      ...
      },
      {
        ...
        title: 'Refactor',
        workDir: '/repo/b',
        sessionDir: '/home/.mirricode/sessions/sess-b',
    ...
    const summaries: SessionSummary[] = [
      {
        id: 'sess-here',
        workDir: '/repo/here',
        sessionDir: '/home/.mirricode/sessions/sess-here',
        createdAt: 0,
        updatedAt: 0,
      },
      {
        ...
        sessionDir: '/home/.mirricode/sessions/sess-elsewhere',
        createdAt: 0,
        updatedAt: 0,
      },
    ];
    ...
    const summaries: SessionSummary[] = [
      {
        id: 'sess-untitled',
        workDir: '/repo/u',
        sessionDir: '/home/.mirricode/sessions/sess-untitled',
        createdAt: 0,
        updatedAt: 1,
      },
      {
        ...
        title: '',
        workDir: '/repo/e',
        sessionDir: '/home/.mirricode/sessions/sess-empty-title',
        createdAt: 0,
        updatedAt: 2,
      },
    ];
