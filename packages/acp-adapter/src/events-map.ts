...
/**
 * Translate the mirri-code TodoList display block into an ACP `plan`
 * session update.
 *
 ...
 *   - We default `priority` to `'medium'` because the mirri-code
 ...
 * the eventual `plan_removed` story (deferred until mirri-code grows
 * a clear-plan signal).
 */
 ...
 *
 * The mirri-code TodoList tool publishes both a structured display
