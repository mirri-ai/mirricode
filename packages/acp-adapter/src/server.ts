...
export class AcpServer implements Agent {
  ...
  constructor(
    ...
    opts?: {
       ...
       * sandboxed test setups (e.g. `{ MIRRICODE_HOME: '/tmp/...' }`);
   ...
   * the mirri-code app's registry. Phase 11 keeps it as a no-op stub.
   */
  async extMethod(
    method: string,
...
/**
 * Project a Mirri SDK {@link SessionSummary} into the ACP
