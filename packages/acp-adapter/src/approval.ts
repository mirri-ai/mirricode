...
import type { ApprovalRequest, ApprovalResponse } from '@mirri-ai/mirri-code-sdk';
 ...
 *    options surfaced in the TUI by `apps/mirri-code/src/tui/reverse-rpc/approval/adapter.ts:13`'s
