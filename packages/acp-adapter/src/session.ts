...
export class AcpSession {
   ...
   * `true` → `'high'` (the typical default for mirri-code), `false`
   ...
   * injecting the `<mirri-skill-loaded>` block — see
 ...
 * `apps/mirri-code/src/tui/commands/parse.ts` and `resolve.ts` to
