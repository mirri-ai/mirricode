...
import { effectiveModelAlias, type ProviderType } from '@mirri-ai/agent-core';
 ...
 */
const TOGGLEABLE_THINKING_MODELS = new Set(['kimi-for-coding', 'mirri-code']);
...
export async function listModelsFromHarness(
  ...
  let config: Awaited<ReturnType<MirriHarness['getConfig']>>;
  try {
