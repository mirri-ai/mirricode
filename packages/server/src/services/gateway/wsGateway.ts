import { createDecorator, type TelemetryClient } from '@mirri-ai/agent-core';
 ...
 */
export const WS_BEARER_PROTOCOL_PREFIX = 'mirri-code.bearer.';
 ...
 * `"mirri-code.bearer.abc, other"`). Returns the token portion of the first
...
export interface WSGatewayOptions {
   ...
   * `Authorization` header or the `mirri-code.bearer.<token>` subprotocol).
