/**
 * Re-export the envelope helpers from `@mirri-ai/protocol`.
 *
 * The wire-shape source of truth lives in `@mirri-ai/protocol`. Re-exporting
 ...
 */
export { okEnvelope, errEnvelope, type Envelope } from '@mirri-ai/protocol';
