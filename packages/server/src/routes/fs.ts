...
import { SessionNotFoundError, FsAlreadyExistsError, FsIsBinaryError, FsIsDirectoryError, FsPathNotFoundError, FsTooLargeError, FsTooManyResultsError, IFsService, FsGrepTimeoutError, IFsSearchService, FsGitUnavailableError, IFsGitService, FsPathEscapesError, type IInstantiationService } from '@mirri-ai/agent-core';
import { z } from 'zod';
...
export function registerFsRoutes(
  ...
  const downloadHandler: Parameters<FsRouteHost['get']>[2] = async (
    ...
    let resolved: import('@mirri-ai/agent-core').FsDownloadResolved;
    try {
