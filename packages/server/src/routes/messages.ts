 ...
 * `@mirri-ai/agent-core`. No SDK package imports.
 */
...
import { IMessageService, MessageNotFoundError, SessionNotFoundError, type IInstantiationService } from '@mirri-ai/agent-core';
import { z } from 'zod';
