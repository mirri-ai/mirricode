...
import type { ICoreProcessService, ILogService, IModelCatalogService } from '@mirri-ai/agent-core';
...
describe('ModelCatalogRefreshScheduler', () => {
  ...
  it('honors env overrides for interval and refresh-on-start', async () => {
    vi.stubEnv('MIRRICODE_MODEL_CATALOG_REFRESH_INTERVAL_MS', '1000');
    vi.stubEnv('MIRRICODE_MODEL_CATALOG_REFRESH_ON_START', '0');
    const scheduler = new ModelCatalogRefreshScheduler(
      catalog as unknown as IModelCatalogService,
