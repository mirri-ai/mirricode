...
//
// Schema + query layer for the mirri-code session store, built on minidb.
//
...
export class SessionStore {
  ...
  async ingestMirriCode(homeDir: string): Promise<{ workspaces: number; sessions: number; textBytes: number }> {
