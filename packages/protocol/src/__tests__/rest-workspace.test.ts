...
const sampleWorkspace: Workspace = {
  id: 'wd_mirri-code_0123456789ab',
  root: '/Users/foo/code/mirri-code',
  name: 'mirri-code',
  is_git_repo: true,
  branch: 'main',
...
describe('workspaceIdSchema', () => {
  ...
  it('accepts dots, dashes, underscores in slug', () => {
    expect(workspaceIdSchema.parse('wd_mirri-code.v2_0123456789ab')).toBe(
      'wd_mirri-code.v2_0123456789ab',
    );
  });
