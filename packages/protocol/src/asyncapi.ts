...
const DEFAULT_TITLE = 'Mirri Code WebSocket API';
...
export function createAsyncApiDocument(
  ...
  return {
    ...
    info: {
      ...
      version,
      description:
        'WebSocket protocol for Mirri Code daemon control frames, acknowledgements, system frames, and session event streaming.',
    },
    ...
    servers: {
      local: {
        ...
        pathname: wsPath,
        description: 'Mirri Code daemon WebSocket endpoint.',
      },
    },
    channels: {
      [CHANNEL_ID]: {
