...
export interface AnthropicOptions {
   ...
   * the provider infers a Claude profile from the model name and falls back
   * to the latest Opus profile for unrecognized Anthropic-compatible models.
   */
...
// Anthropic's native effort values are resolved before reaching this adapter;
// `budgetTokensForEffort` narrows the budget-based subset.
