...
describe('provisionManagedMirriCodeConfig', () => {
  ...
  it('writes the managed provider, models, services, and default model through an adapter', async () => {
    ...
    expect(fetchMock).toHaveBeenCalledWith(
      'https://api.mirricode.com/coding/v1/models',
    ...
    expect(config.services?.moonshotSearch).toMatchObject({
      baseUrl: 'https://api.mirricode.com/coding/v1/search',
      apiKey: '',
      oauth: { storage: 'file', key: 'oauth/mirri-code' },
    });
  ...
  it('removes managed provider, models, services, and default model on logout', () => {
    const config: ManagedMirriConfigShape = {
      ...
      services: {
        moonshotSearch: { baseUrl: 'https://api.mirricode.com/coding/v1/search' },
        moonshotFetch: { baseUrl: 'https://api.mirricode.com/coding/v1/fetch' },
      ...
      raw: {
        ...
        services: {
          moonshot_search: { base_url: 'https://api.mirricode.com/coding/v1/search' },
          moonshot_fetch: { base_url: 'https://api.mirricode.com/coding/v1/fetch' },
        },
      },
    };

    applyManagedMirriCodeLogoutConfig(config);
  ...
  it('clears managed provider, models, default model, and services on logout', () => {
    const config: ManagedMirriConfigShape = {
      ...
      services: {
        ...
        moonshotFetch: {
          baseUrl: 'https://api.mirricode.com/coding/v1/fetch',
          apiKey: '',
          oauth: { storage: 'file', key: 'oauth/mirri-code' },
        },
...
describe('applyManagedApiKeyProviderModels', () => {
  ...
  it('writes protocol routing fields for anthropic-protocol models', () => {
    const config: ManagedMirriConfigShape = { providers: {}, models: {} };
...
const MIRRI_BASE_URL = 'https://api.mirricode.com/coding/v1';
