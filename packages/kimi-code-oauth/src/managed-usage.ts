 ...
 *
 * Only `managed:mirri-code` is supported today. The platform exposes a
...
export const DEFAULT_MIRRICODE_BASE_URL = 'https://api.mirricode.com/coding/v1';

export function isManagedMirriCode(providerKey?: string | null): boolean {
 ...
 */
export function isManagedMirriCodeBaseUrl(baseUrl: string | undefined): boolean {
