 ...
 *
 * Wire shapes the engine imports from `@mirri-ai/protocol` are reached
...
import type {
  ...
  ToolCallRef,
  TurnPhase,
} from '@mirri-ai/agent-core-v2/agent/activityView/activityView';
import type { AgentContextData } from '@mirri-ai/agent-core-v2/agent/contextMemory/types';
import type { TurnEndReason } from '@mirri-ai/agent-core-v2/agent/loop/turnEvents';
import type { PlanData } from '@mirri-ai/agent-core-v2/agent/plan/plan';
import type {
  AgentAPI,
  CancelPlanPayload,
  ...
  ShellCommandResult,
  StopTaskPayload,
} from '@mirri-ai/agent-core-v2/agent/rpc/core-api';
import type { UsageStatus } from '@mirri-ai/agent-core-v2/agent/usage/usage';
import type { ISessionScopeHandle } from '@mirri-ai/agent-core-v2/_base/di/scope';
import type {
  CreateChildSessionOptions,
  CreateSessionOptions,
  ForkSessionOptions,
} from '@mirri-ai/agent-core-v2/workspace/sessionLifecycle/sessionLifecycle';
import type {
  ApprovalRequest,
  ApprovalResponse,
} from '@mirri-ai/agent-core-v2/session/approval/approval';
import type {
  Interaction,
  InteractionResolution,
} from '@mirri-ai/agent-core-v2/session/interaction/interaction';
import type {
  QuestionAnswers,
  QuestionItem,
  QuestionOption,
  ...
  QuestionResponse,
  QuestionResult,
} from '@mirri-ai/agent-core-v2/session/question/question';
import type {
  AgentMeta,
  SessionMeta,
  SessionMetadataChangedEvent,
  SessionMetaPatch,
} from '@mirri-ai/agent-core-v2/session/sessionMetadata/sessionMetadata';
import type {
  AuthStatus,
  IOAuthService,
} from '@mirri-ai/agent-core-v2/app/auth/auth';
import type { IBootstrapService } from '@mirri-ai/agent-core-v2/app/bootstrap/bootstrap';
import type {
  ConfigDiagnostic,
  ConfigInspectValue,
  ConfigTarget,
} from '@mirri-ai/agent-core-v2/app/config/config';
import type { ExperimentalFeatureState } from '@mirri-ai/agent-core-v2/app/flag/flag';
import type {
  FsBrowseResponse,
  FsHomeResponse,
} from '@mirri-ai/agent-core-v2/app/hostFolderBrowser/hostFolderBrowser';
import type { ModelRecord } from '@mirri-ai/agent-core-v2/kosong/model/model';
import type { IModelCatalog } from '@mirri-ai/agent-core-v2/kosong/model/catalog';
import type { IProviderDiscoveryService } from '@mirri-ai/agent-core-v2/app/kosongConfig/discovery';
import type {
  GetPluginInfoInput,
  InstallPluginInput,
  RemovePluginInput,
...
} from '@mirri-ai/agent-core-v2/app/plugin/plugin';
import type {
  PluginCommandDef,
  PluginDiagnostic,
  ...
  PluginUpdateStatus,
  ReloadSummary,
} from '@mirri-ai/agent-core-v2/app/plugin/types';
import type { ProviderConfig } from '@mirri-ai/agent-core-v2/kosong/provider/provider';
import type {
  SessionListQuery,
  SessionSummary,
} from '@mirri-ai/agent-core-v2/app/sessionIndex/sessionIndex';
import type {
  Workspace,
  WorkspaceUpdate,
} from '@mirri-ai/agent-core-v2/app/workspace/workspace';
// Test-only: `@mirri-ai/protocol` is a devDependency; importing its types
...
// `@mirri-ai/protocol` dependency in klient).
...
const _agentTaskInfo: AssertWire<typeof agentTaskInfoSchema, BackgroundTaskInfo> = true;
...
// Mirricode protocol does not export `PromptCompletedEvent` / `PromptAbortedEvent`
// interfaces (only REST payload shapes). Parity is pinned to the klient-owned
// schemas inferred types instead.
const _promptCompletedEvent: AssertWire<
  typeof promptCompletedEventSchema,
  z.infer<typeof promptCompletedEventSchema>
> = true;
const _promptAbortedEvent: AssertWire<
  typeof promptAbortedEventSchema,
  z.infer<typeof promptAbortedEventSchema>
> = true;
