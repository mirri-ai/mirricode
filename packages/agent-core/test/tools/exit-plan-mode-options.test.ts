...
describe('ExitPlanMode option output', () => {
  ...
  it('should mark the direct-execution output as auto-approved when in auto mode', async () => {
  ...
  it('should keep the user-approved output when a rule lets the call through outside auto mode', async () => {
