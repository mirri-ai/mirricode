...
import { APIStatusError, type Message } from '@mirri-ai/kosong';
...
// The OpenAI-compatible (Mirri / Kimi) phrasing of the same tool-exchange
...
describe('executeLoopStep — tool exchange adjacency fallback', () => {
  ...
  it('resends once and recovers after a Mirri tool_call_id-not-found 400', async () => {
