...
export const ThinkingConfigSchema = z.object({
  ...
  // Mirri Preserved Thinking passthrough (`thinking.keep`). The value is
...
export const ImageConfigSchema = z.object({
   ...
   * Overrides the built-in default; the MIRRICODE_IMAGE_MAX_EDGE_PX env var wins
   * over this value.
   */
   ...
   * MIRRICODE_IMAGE_READ_BYTE_BUDGET env var wins over this value. Explicit
...
export const MirriServiceConfigSchema = z.object({
  baseUrl: z.string().optional(),
  apiKey: z.string().optional(),
  oauth: OAuthRefSchema.optional(),
  customHeaders: StringRecordSchema.optional(),
...
export type MirriServiceConfig = z.infer<typeof MirriServiceConfigSchema>;

export const ServicesConfigSchema = z.object({
  moonshotSearch: MirriServiceConfigSchema.optional(),
  moonshotFetch: MirriServiceConfigSchema.optional(),
});
...
const MirriServiceConfigPatchSchema = MirriServiceConfigSchema.partial();
const ServicesConfigPatchSchema = z.object({
  moonshotSearch: MirriServiceConfigPatchSchema.optional(),
