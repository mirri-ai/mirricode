import type { MirriConfig } from './schema';

/**
 * Print-mode (`mirri -p`) defaults for the v1 engine. A headless run should not
 ...
 */
export function applyPrintModeConfigDefaults(config: MirriConfig): MirriConfig {
  return {
    ...config,
