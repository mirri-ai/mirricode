 ...
 *   3. `<MIRRICODE_HOME>/bin/rg` — persistent cache for this app.
 *   4. CDN download to <MIRRICODE_HOME>/bin/ — one-off bootstrap
 *
...
const RG_BASE_URL = 'https://code.kimi.com/mirri-code/rg';
