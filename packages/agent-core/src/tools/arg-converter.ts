/**
 * Schema-based argument converter for tool call arguments.
 *
 * This module provides precise type conversion based on JSON Schema definitions.
 * It converts string values to numbers/integers when the schema expects numeric types,
 * improving tolerance for LLM responses that serialize numeric arguments as strings.
 */
 ...
 *
 * This function traverses the schema and converts string values to numbers
 * when the schema expects integer or number types. It handles:
 * - Direct type definitions (type: "integer", type: "number")
 * - anyOf with numeric branches
 * - Nested objects
 ...
 */
export function convertArgsBySchema(schema: unknown, args: unknown): unknown {
