...
export interface SessionSkillConfig {
  ...
  /** Brand data dir (MIRRICODE_HOME); user brand skills live under `<brandHomeDir>/skills`. */
...
const BACKGROUND_KEEP_ALIVE_ON_EXIT_ENV = 'MIRRICODE_BACKGROUND_KEEP_ALIVE_ON_EXIT';
...
export class Session {
  ...
  /**
   * Resolve the effective print-mode (`mirri -p`) background-task policy.
   *
  ...
  /**
   * Decide what the `mirri -p` driver should do after the main agent's turn ends
