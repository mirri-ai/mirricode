...
import type { ChatProvider, Tool } from '@mirri-ai/kosong';
    ...
    this.builtinTools = new Map(
      [
        ...
        new b.BashTool(kaos, cwd, background, {
          allowBackground,
          backgroundTimeoutS: this.agent.mirriConfig?.background?.bashTaskTimeoutS,
          autoBackgroundOnTimeout:
            this.agent.mirriConfig?.background?.bashAutoBackgroundOnTimeout ?? true,
        }),
