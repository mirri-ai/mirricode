 ...
 * autocomplete and typo-checking. `env` must start with 'MIRRICODE_EXPERIMENTAL_', be unique, and
 * not equal the master switch 'MIRRICODE_EXPERIMENTAL_FLAG'; `id` must not be 'flag'.
 */
export const FLAG_DEFINITIONS = [
  ...
  //   env: 'MIRRICODE_EXPERIMENTAL_MICRO_COMPACTION',
  //   default: false,
  //   surface: 'core',
  // },
  {
