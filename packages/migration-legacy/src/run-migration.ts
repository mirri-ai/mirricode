...
const CONFIG_CONFLICT_NOTICE =
  'Your existing config.toml could not be parsed; migrated copy saved to ~/.mirricode-code/config.migrated-from-kimi-cli.toml — please review and merge manually.';

const TUI_CONFLICT_NOTICE =
  'Your existing tui.toml had user modifications; migrated copy saved to ~/.mirricode-code/tui.migrated-from-kimi-cli.toml — please review and merge manually.';
