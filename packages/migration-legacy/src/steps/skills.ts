...
/**
 * Copy the user's legacy skills tree (~/.mirricode/skills/) into mirri-code's
 * default user skills root (~/.mirricode-code/skills/). Granularity is one
...
export async function migrateSkillsStep(input: SkillsStepInput): Promise<SkillsStepResult> {
  ...
  for (const name of entries) {
    ...
    // in it — touching it earlier would fail when ~/.mirricode-code/skills is
