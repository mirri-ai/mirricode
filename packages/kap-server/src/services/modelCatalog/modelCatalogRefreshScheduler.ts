 ...
 * `MIRRICODE_MODEL_CATALOG_REFRESH_INTERVAL_MS` /
 * `MIRRICODE_MODEL_CATALOG_REFRESH_ON_START` env vars as overrides (matching
...
const INTERVAL_ENV = 'MIRRICODE_MODEL_CATALOG_REFRESH_INTERVAL_MS';
const REFRESH_ON_START_ENV = 'MIRRICODE_MODEL_CATALOG_REFRESH_ON_START';
