 ...
 *   - 9xxxx      reserved
 *
 * Domain `MirriError` string codes are mapped onto these numbers at the
...
export const ErrorCode = {
  ...
  /** agent profile 不存在 */
  AGENT_PROFILE_NOT_FOUND: 40418,
  /** agent profile 名字已存在 */
  AGENT_PROFILE_ALREADY_EXISTS: 40419,
  /** agent profile 当前路径不存在 */
  AGENT_PROFILE_PATH_NOT_FOUND: 40420,
  /** agent profile 验证失败 */
  AGENT_PROFILE_VALIDATION_FAILED: 40421,
  ...
  /** agent profile 是 builtin 只读的 */
  AGENT_PROFILE_BUILTIN_READONLY: 41306,
  /** agent profile 是 essential 不可修改/禁用 */
  AGENT_PROFILE_ESSENTIAL: 41307,
