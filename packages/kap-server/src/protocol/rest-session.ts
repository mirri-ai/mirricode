...
import { messageSchema } from '@mirri-ai/agent-core-v2/agent/contextMemory/protocolMessage';
import {
...
export const exportSessionRequestSchema = z
  .object({
    ...
    // (`<home>/logs/mirri-code-desktop.log`) into the archive; the server reads
