...
import { IMessageLegacyService, isError2, type Scope } from '@mirri-ai/agent-core-v2';
import { messageRoleSchema } from '@mirri-ai/agent-core-v2/agent/contextMemory/protocolMessage';
