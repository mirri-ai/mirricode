 ...
 *
 * **Reader strategy** (controlled by `MIRRI_SNAPSHOT_READER`):
 *
 ...
 *
 * **Timeout**: the auto path races against a hard `MIRRI_SNAPSHOT_TIMEOUT_MS`
...
import type { Message } from '@mirri-ai/agent-core-v2/agent/contextMemory/protocolMessage';
