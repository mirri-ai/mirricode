...
import type { DomainEvent } from '@mirri-ai/agent-core-v2/app/event/eventBus';
import type { MessageContent } from '@mirri-ai/agent-core-v2/agent/contextMemory/protocolMessage';
