...
export type SetMirriConfigPayload = ResolvedConfig;
...
export interface CoreAPI extends SessionAPIWithId {
  ...
  getMirriConfig: (payload: GetMirriConfigPayload) => ResolvedConfig;
  getConfigDiagnostics: (payload: EmptyPayload) => ConfigDiagnostics;
  setMirriConfig: (payload: SetMirriConfigPayload) => ResolvedConfig;
  removeMirriProvider: (payload: RemoveMirriProviderPayload) => ResolvedConfig;
