      ...
      if (fileType.kind === 'image' && !this.capabilities.image_in) {
        return {
          ...
          output:
            ...
            'Dispatch a subagent whose model supports image input (see the "Available models" list in the Agent tool description) to analyze this image.',
        };
      }
      ...
      if (fileType.kind === 'video' && !this.capabilities.video_in) {
        return {
          ...
          output:
            ...
            'Dispatch a subagent whose model supports video input (see the "Available models" list in the Agent tool description) to analyze this video.',
        };
      }
