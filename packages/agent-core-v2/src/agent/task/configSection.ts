 ...
 * accept the v1 env overrides `MIRRICODE_BACKGROUND_KEEP_ALIVE_ON_EXIT` /
 * `MIRRICODE_BACKGROUND_MAX_RUNNING_TASKS`
...
export const KEEP_ALIVE_ON_EXIT_ENV = 'MIRRICODE_BACKGROUND_KEEP_ALIVE_ON_EXIT';
export const MAX_RUNNING_TASKS_ENV = 'MIRRICODE_BACKGROUND_MAX_RUNNING_TASKS';
