 ...
 * budgets also accept operational env overrides (`MIRRI_LOOP_MAX_STEPS_PER_TURN`
 * / `MIRRI_LOOP_MAX_RETRIES_PER_STEP`); `config` resolves each field as
...
export const LOOP_MAX_STEPS_PER_TURN_ENV = 'MIRRI_LOOP_MAX_STEPS_PER_TURN';
export const LOOP_MAX_RETRIES_PER_STEP_ENV = 'MIRRI_LOOP_MAX_RETRIES_PER_STEP';
