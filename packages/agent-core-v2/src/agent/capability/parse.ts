/**
 * `capability` domain — YAML parsing for integrations.yaml.
 *
 ...
 * is expected to surface warnings but keep going. Never throws for
 * user-authored content — only invariants like a non-string input trigger
 * throws.
 */
