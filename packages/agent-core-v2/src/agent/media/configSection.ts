 ...
 * operational env override (`MIRRI_IMAGE_MAX_EDGE_PX` /
 * `MIRRI_IMAGE_READ_BYTE_BUDGET`); `config` resolves each field as
...
export const IMAGE_MAX_EDGE_ENV = 'MIRRI_IMAGE_MAX_EDGE_PX';
export const IMAGE_READ_BYTE_BUDGET_ENV = 'MIRRI_IMAGE_READ_BYTE_BUDGET';
