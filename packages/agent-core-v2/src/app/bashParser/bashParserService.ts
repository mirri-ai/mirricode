 ...
 *
 * Thin adapter over the pure `@mirri-ai/tree-sitter-bash` package: runs
...
import { parse } from '@mirri-ai/tree-sitter-bash';
import type { SyntaxNode } from '@mirri-ai/tree-sitter-bash';
