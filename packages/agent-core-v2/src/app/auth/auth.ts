...
export interface IOAuthToolkit {
  ...
  login(providerName?: string, options?: MirriOAuthLoginOptions): Promise<MirriOAuthLoginResult>;
  logout(providerName?: string, oauthRef?: MirriOAuthTokenRef): Promise<MirriOAuthLogoutResult>;
  getCachedAccessToken(
    providerName?: string,
    oauthRef?: MirriOAuthTokenRef,
  ): Promise<string | undefined>;
  tokenProvider(providerName?: string, oauthRef?: MirriOAuthTokenRef): BearerTokenProvider;
  getManagedUsage(
    providerName?: string,
    options?: { readonly oauthRef?: MirriOAuthTokenRef; readonly baseUrl?: string },
