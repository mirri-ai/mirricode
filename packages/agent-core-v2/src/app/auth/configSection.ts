 ...
 * (`MIRRI_WEB_SEARCH_*` / `MIRRI_WEB_FETCH_*`, env wins over the file). Its
...
export const WEB_SEARCH_BASE_URL_ENV = 'MIRRI_WEB_SEARCH_BASE_URL';
export const WEB_SEARCH_API_KEY_ENV = 'MIRRI_WEB_SEARCH_API_KEY';
export const WEB_FETCH_BASE_URL_ENV = 'MIRRI_WEB_FETCH_BASE_URL';
export const WEB_FETCH_API_KEY_ENV = 'MIRRI_WEB_FETCH_API_KEY';
