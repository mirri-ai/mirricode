...
export function normalizeMirriToolSchema(schema: Record<string, unknown>): Record<string, unknown> {
  return ensureMirriPropertyTypes(derefJsonSchema(schema));
}

function ensureMirriPropertyTypes(schema: Record<string, unknown>): Record<string, unknown> {
