 ...
 *
 * Usage:
 *   pnpm --filter @mirri-ai/agent-core-v2 gen:state-manifest          # write the file
 *   pnpm --filter @mirri-ai/agent-core-v2 gen:state-manifest --check  # freshness check (CI-style)
 *
...
function renderManifest(
  ...
  const out: string[] = [
    ...
    '// Regenerate with: pnpm --filter @mirri-ai/agent-core-v2 gen:state-manifest',
    '//',
