 ...
 *
 * Usage:
 *   pnpm --filter @mirri-ai/agent-core-v2 gen:wire-manifest          # write the file
 *   pnpm --filter @mirri-ai/agent-core-v2 gen:wire-manifest --check  # freshness check (CI-style)
 *
...
export async function buildWireManifest(): Promise<string> {
  ...
  const out: string[] = [
    ...
    '// Regenerate with: pnpm --filter @mirri-ai/agent-core-v2 gen:wire-manifest',
    '//',
