 ...
 * ban over `test/**` too):
 *
 *  1. **No v1 imports** — v2 must never `import '@mirri-ai/agent-core'`
 ...
 * self-reference (`@mirri-ai/agent-core-v2/<path>` → `src/<path>`) are
 * resolved against `src/`. Sibling packages (`@mirri-ai/*` other than v1)
...
// oxlint-disable-next-line no-unused-vars — oxlint type-aware mode fails to see usage at line 349; verified used in `isMain` check below.
...
const V1_PACKAGE = '@mirri-ai/agent-core';
const SELF_PACKAGE_PREFIX = '@mirri-ai/agent-core-v2/';
...
function resolveIntraV2(specifier, fromFile) {
  ...
  // The package's legal self-reference: `@mirri-ai/agent-core-v2/x` maps
