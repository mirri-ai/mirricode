...
interface ContextAppendMessagePayload {
  ...
  message: {
    ...
    origin?: 'user' | 'skill_activation' | 'plugin_command' | 'injection' | 'shell_command' | 'compaction_summary' | 'system_trigger' | 'background_task' | 'cron_job' | 'cron_missed' | 'hook_result' | 'hook_additional_context' | 'retry' | undefined;
    isError?: boolean;
    note?: string;
  };
}
...
interface TurnPromptPayload {
  ...
  /** PromptOrigin */
  origin: 'user' | 'skill_activation' | 'plugin_command' | 'injection' | 'shell_command' | 'compaction_summary' | 'system_trigger' | 'background_task' | 'cron_job' | 'cron_missed' | 'hook_result' | 'hook_additional_context' | 'retry';
}
