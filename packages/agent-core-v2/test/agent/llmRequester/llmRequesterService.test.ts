...
import { IMessagePipelineService } from '#/agent/messagePipeline/messagePipeline';
...
// All modalities supported so the capability projector passes media through
// unchanged — these tests exercise size-driven degradation, not capability
// adaptation (covered by mediaCapabilityProjector.test.ts).
...
function createService(
  ...
  ix.stub(IMessagePipelineService, {
