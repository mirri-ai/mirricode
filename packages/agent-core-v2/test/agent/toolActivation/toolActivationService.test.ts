...
import { CapabilityResolverService } from '#/agent/capability/capabilityResolverService';
  ...
  function createActivationHost() {
    ...
    return createServices(disposables, {
      ...
      additionalServices: (reg) => {
        ...
        reg.definePartialInstance(IBootstrapService, { homeDir: '/tmp' });
        reg.definePartialInstance(IHostEnvironment, { homeDir: '/tmp' });
        reg.define(ICapabilityResolverService, CapabilityResolverService);
